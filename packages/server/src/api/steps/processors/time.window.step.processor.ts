...
@Processor('{time.window.step}', {
  stalledInterval: process.env.TIME_WINDOW_STEP_PROCESSOR_STALLED_INTERVAL
    ? +process.env.TIME_WINDOW_STEP_PROCESSOR_STALLED_INTERVAL
    : 600000,
  removeOnComplete: {
    age: process.env.STEP_PROCESSOR_REMOVE_ON_COMPLETE_AGE
      ? +process.env.STEP_PROCESSOR_REMOVE_ON_COMPLETE_AGE
      : 0,
    count: process.env.TIME_WINDOW_STEP_PROCESSOR_REMOVE_ON_COMPLETE
      ? +process.env.TIME_WINDOW_STEP_PROCESSOR_REMOVE_ON_COMPLETE
      : 0,
  },
  metrics: {
    maxDataPoints: MetricsTime.ONE_WEEK,
  },
  concurrency: process.env.TIME_WINDOW_STEP_PROCESSOR_CONCURRENCY
    ? +process.env.TIME_WINDOW_STEP_PROCESSOR_CONCURRENCY
    : 1,
})
export class TimeWindowStepProcessor extends WorkerHost {
  constructor(
